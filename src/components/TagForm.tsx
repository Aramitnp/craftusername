...
export default function TagForm({ initialData }: TagFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    robots: initialData?.robots || "noindex, follow",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(initialData ? `/api/blog/tags/${initialData.id}` : `/api/blog/tags`, {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          ...
          <Card>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem", marginTop: "1rem" }}>
              <div>
                <label className="label-md" style={{ marginBottom: "0.5rem", display: "block" }}>Tag Name</label>
                <Input required value={formData.name} onChange={handleNameChange} placeholder="e.g. Tips" />
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem", marginTop: "1rem" }}>
              ...
              <div>
                ...
                >
                  ...
                  <option value="noindex, follow">noindex, follow (Default for Tags)</option>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: "1rem", marginTop: "1rem", paddingTop: "1rem", borderTop: "1px solid var(--color-outline)" }}>
        <Button type="button" variant="ghost" onClick={() => router.push("/admin/blog/tags")}>Cancel</Button>
